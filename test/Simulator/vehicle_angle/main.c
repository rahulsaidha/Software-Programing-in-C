...
int main(void)
{
    ...
    vehicle->direction_actuator_pos = 0.0;
    vehicle_angle(0.01, vehicle);
    print_results(fp,1,'=',0.0,vehicle->vehicle_wheel_angle,'=',0.0,vehicle->vehicle_angle);
    ...
    vehicle_angle(0.01, vehicle);
    print_results(fp,2,'>',0.0,vehicle->vehicle_wheel_angle,'>',0.0,vehicle->vehicle_angle);
    ...
    vehicle->direction_actuator_pos = -10.0;
    vehicle_angle(0.01, vehicle);
    print_results(fp,3,'<',0.0,vehicle->vehicle_wheel_angle,'<',0.0,vehicle->vehicle_angle);
    ...
    vehicle_angle(0.01, vehicle);
    print_results(fp,4,'>',0.0,vehicle->vehicle_wheel_angle,'~',-3.1415,vehicle->vehicle_angle);
    ...
    vehicle->vehicle_angle = -PI + 0.001;
    vehicle_angle(0.01, vehicle);
    print_results(fp,5,'<',0.0,vehicle->vehicle_wheel_angle,'~',3.141,vehicle->vehicle_angle);
    ...
    vehicle->direction_actuator_pos = 10.0;
    vehicle_angle(0.01, vehicle);
    print_results(fp,6,'>',0.0,vehicle->vehicle_wheel_angle,'=',2.0,vehicle->vehicle_angle);
